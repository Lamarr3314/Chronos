window.addEventListener("load", () => {
  ...
  const presetdata = [
    [
      "Bob Jones",
      "12:00 PM",
      "With chronos, I was able to complete many of my objectives and stay on track. I finally landed a job at Apple, and it's all thanks to #Chronos",
    ],
    [
      "Lamarr Olive",
      "12:00 PM",
      "Just hit the one week streak! Excited to keep going and achieve more goals.",
    ],
    [
      "Deyby Rodriguez",
      "10:00 AM",
      "First time using this application, and I love it. I'm able to get all my tasks done and also stay motivated by looking at these posts.",
    ],
  ];
